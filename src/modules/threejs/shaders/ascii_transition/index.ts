...
export class ASCIITransitionShaderMaterial extends asciiShader {
  public uniforms: {
    ...
    u_TextureTarget?: IUniform<Texture>
  }
  ...
  setTextureTarget(texture: Texture) {
    this.uniforms.u_TextureTarget = new Uniform(texture)
  }
}
