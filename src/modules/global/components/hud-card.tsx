...
export function HudCard({ title, footerLabel, coordinates = "0.00 / 0.00", children, className }: HudCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="flex justify-between items-center px-4 py-2.5 bg-terminal-bg-overlay/90 border-b border-terminal-border">
        <span className="text-xxs tracking-[3px] text-terminal-text-muted">{title}</span>
      ...
      <div className="flex justify-between items-center px-4 py-2 bg-terminal-bg-overlay/90 border-t border-terminal-border">
        <span className="text-[8px] tracking-[2px] text-terminal-text-muted">{footerLabel}</span>
        <span className="text-[8px] tracking-[1px] text-terminal-text-muted tabular-nums">{coordinates}</span>
      </div>
    </div>
  )
}
